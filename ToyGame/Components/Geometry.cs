...
namespace ToyGame
{
  class Geometry
  {
    ...
    public Geometry(Mesh mesh, BufferUsageHint usage = BufferUsageHint.StaticDraw)
      : this(mesh.Positions, mesh.Indices, mesh.Normals, mesh.UV0, null, null, usage)
    {
    }

    public Geometry(Vector3[] positions, uint[] indexes, Vector3[] normals = null, Vector2[] uv0 = null,
      Vector2[] uv1 = null, Color4[] colors = null, BufferUsageHint usage = BufferUsageHint.StaticDraw)
    {
      ...
      Debug.Assert((normals == null || positions.Length == normals.Length) && (uv0 == null || positions.Length == uv0.Length)
